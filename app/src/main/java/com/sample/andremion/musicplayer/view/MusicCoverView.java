...
public class MusicCoverView extends ImageView implements Animatable {
    ...
    private static final int DURATION = 80000;
    private static final int DURATION_END = 1000;
    private static final float DURATION_PER_DEGREES = DURATION_END / FULL_ANGLE;
