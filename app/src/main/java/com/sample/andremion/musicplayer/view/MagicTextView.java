...
public class MagicTextView extends android.support.v7.widget.AppCompatTextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.MagicTextView_textViewBackground)){
				Drawable background = a.getDrawable(R.styleable.MagicTextView_textViewBackground);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_textViewBackground, 0xff000000));
				}
			}
